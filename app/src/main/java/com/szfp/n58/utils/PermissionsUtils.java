...
import com.szfp.n58.callback.onRequestPermissionsListener;
...
public class PermissionsUtils {
    ...
    public static void requestPhome(Context mContext, onRequestPermissionsListener onRequestPermissionsListener) {
